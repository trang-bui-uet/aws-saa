...
description: Dịch nội dung sang tiếng Việt (giữ đủ ý, dễ đọc, bôi đậm phần quan trọng) và đặt Cornell Note phía trên bản dịch. Dùng khi người dùng yêu cầu dịch bài học, tóm tắt theo Cornell, hoặc nhắc đến dịch tiếng Việt + Cornell Note.
---
...
3. Đặt khối **Tóm tắt theo Cornell Note** ngay **bên trên** bản dịch (sau tiêu đề).
...
Luôn trả về theo cấu trúc sau — **Cornell Note trước, bản dịch sau**:
...
## Ví dụ định dạng đầu ra (dùng đúng mẫu này)

```markdown
# Bootstrap EC2 bằng User Data (thủ công & CloudFormation)
...
- [ ] Cornell Note nằm **bên trên** bản dịch (sau tiêu đề, trước nội dung dịch)
